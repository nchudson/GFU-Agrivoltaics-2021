...
void read_sensors() {
  ...
  irad_0_wsqm = (irad_samples < 0) ? 0 : irad_samples / NUM_SAMPLES;
  // Convert ADC counts to W/m^2.
  irad_0_wsqm = (float)((-8E-10 * pow(irad_0_wsqm, 4)) +
    (3E-6 * pow(irad_0_wsqm, 3)) - (3.02E-3 * pow(irad_0_wsqm, 2)) +
    (1.1024 * (double)irad_0_wsqm));
